...
import { FaHome, FaDev, FaHistory, FaChartLine, FaEnvelope, FaUser } from 'react-icons/fa'; // Import các icon
import './Sidebar.css';
...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar">
      ...
      <Link to="/devices" className={`sidebar-item ${location.pathname === '/devices' ? 'active' : ''}`}>
        <FaDev /> {/* Icon Devices */}
        <span>Devices</span>
      </Link>
